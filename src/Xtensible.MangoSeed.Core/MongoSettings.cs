namespace Xtensible.MangoSeed.Core
{
    ...
    ///     Authentication options for connecting to MongoDb
    ///     <see href="https://docs.mongodb.com/manual/core/security-scram/" />
    /// </param>
    ...
    public record MongoSettings(string Server, string? AuthenticationMechanism = "SCRAM-SHA-1", bool UseTls = false,
        bool AllowInsecureTls = false, string? Username = null, string? Password = null,
